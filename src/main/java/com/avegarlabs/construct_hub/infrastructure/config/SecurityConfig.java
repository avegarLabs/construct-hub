...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // Primero CORS
    ...
    public UrlBasedCorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://construct-hub-app:4200", "http://localhost:4200", "http://contruct-hub.vertice.com.cu:4200"));
